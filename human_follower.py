...
from fps_demo import WebcamVideoStream
from motor_driver_3 import Driver
import RPi.GPIO as GPIO
import sys
GPIO.setmode(GPIO.BCM)
left_Driver=Driver(19,26,20,21)
right_Driver=Driver(9,27,10,11)
...
def move_robot():
    ...
    if(abs(x_deviation)<tolerance):
        ...
        if(y<0.1):
            ...
            cmd="forward"
            right_Driver.right_forward()
            left_Driver.left_forward()
